...
combined_performance as (
    ...
    from batting_agg b
    full outer join bowling_agg bo 
        on b.match_id = bo.match_id 
        and b.batter_id = bo.bowler_id -- Join on player
),
...
final as (
    select
        ...
        case 
            when cp.team_id = m.team1_id then m.team2_id
            when cp.team_id = m.team2_id then m.team1_id
            else null
